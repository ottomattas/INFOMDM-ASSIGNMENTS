...
trees = []
for cycle in tqdm(range(NUMEXECUTIONS), desc='Single Trees'):
...
print("Saving output...")
outputfile = "output_single_tree.txt"
with open(outputfile, "w") as f:
    for idx, tree in tqdm(enumerate(trees), desc="Printing statistics"):
        f.write("Accuracy Run #" + str(idx+1) + ":\t" + str(calculateTreePerformanceStats(tdata, classes, tree, bagging=False)["accuracy"]) + "\n")
